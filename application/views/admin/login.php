...
<head>
    ...
    <title>Timbre Media Radio Admin</title>
                    ...
                    <div class="panel-body">
                        <form name="loginForm">
                            <fieldset>
                                ...
                                <a href="<?php echo base_url();?>admin/index/forgot_password" >Forgot Password?</a>
                                <!-- Change this to a button or input when using this as a form -->
                                <a id="user_login" class="btn btn-lg btn-success btn-block">Login</a>
                            </fieldset>
                        </form>
                    </div>
                </div>
...
<script>
	$(document).ready(function(){
	  ...
	  $('#user_login').click(function(){
			...
			{
			    $('#message_div').html("<div class='alert alert-info'>Checking Credentials....</div>");
				...
				$.ajax({
					...
					success:function(data) {
						  if (data.status=='success'){
						    //$('#message_div').html("<div class='alert alert-success'>Login Success Redirecting....</div>");
							window.location.href = "<?php echo base_url();?>admin";		    				  
						  }
						  else{			  
							 $('#message_div').html("<div class='alert alert-danger'>"+data.message+"</div>");					
						  }
					}             
				});
		    }
