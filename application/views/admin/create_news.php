    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-lg-6">
              <form role="form" id="create_news_form" name="create_news_form">
                ...
                <div class="form-group">
                  <label>Company</label>
                  <br />
                  <select multiple="multiple" placeholder="Select Company" name="company_id[]" id="company_id" class="SlectBox" required>
...
$(document).ready(function(){
	...
	$('#create_news_form').submit(function(e) {
	       e.preventDefault();
		   var title = $("#title").val();
		   ...
		   $('.loadings').show();	
		   dataString = jQuery('form[name=create_news_form]').serialize();  
		   $.ajax({   
							type:'POST',
							data:dataString,
							dataType:'json',
							url:'<?php echo base_url();?>'+'index.php/admin/custom_ajax/create_news',
